...
--
-- Dumping events for database 'schooled_web_application'
--

--
-- Dumping routines for database 'schooled_web_application'
--
/*!50003 DROP PROCEDURE IF EXISTS `MemberCount` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `MemberCount`(IN group_id VARCHAR(50), OUT quantity INT)
SELECT COUNT(*)
    INTO quantity
    FROM user
    JOIN group_member
...
-- Dump completed on 2021-11-14 21:42:42
